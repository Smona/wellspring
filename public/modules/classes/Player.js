...
function Player(x, y) {
  ...
  //this.sprite.animations.add ("dance", [16, 17, 18, 19], 1, true);
  //this.sprite.animations.add ("sit", [20, 21], playbackRate, true);
  //this.sprite.animations.add ("facePlant", [22, 23], playbackRate, true);
  //this.sprite.animations.add ("scooch", [24, 25, 26, 27, 28], 5, true);
  //this.sprite.animations.add ("gettingUp", [29, 30, 31], 5, true);
